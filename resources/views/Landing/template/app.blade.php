<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('public/landing/images/Logo/Logo-CS-New-Transparan.png') }}">
    <!-- Bootstrap -->
    ...
    <!-- FLEXSLIDER -->
    <link href="{{ asset('public/landing/css/flexslider.css') }}" rel="stylesheet" type="text/css" />
    <!-- Main css --> 
  ...
  <body>
   ...
   <!-- javascript -->
    ...
    <script src="{{ asset('public/landing/js/magnific.init.js') }}"></script>
    <!-- SLIDER -->
    <script src="{{ asset('public/landing/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('public/landing/js/owl.init.js') }}"></script>
    <!--FLEX SLIDER-->
    <script src="{{ asset('public/landing/js/jquery.flexslider-min.js') }}"></script>
    <script src="{{ asset('public/landing/js/flexslider.init.js') }}"></script>
    <!-- Counter -->
    <script src="{{ asset('public/landing/js/counter.init.js') }}"></script>
    <!-- Main Js -->
